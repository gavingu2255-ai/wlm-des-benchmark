...
The scaffold row on h separates structure from semantics. Near zero
...
passes through a judge, so it is immune to the circularity concern
...
#                      the condition the circularity concern predicts
#                      will close the gap.
#
